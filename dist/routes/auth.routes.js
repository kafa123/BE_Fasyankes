...
Router.post('/requestPasswordReset', upload_1.default.none(), auth_controller_1.AuthController.requestPasswordReset);
Router.post('/resetpassword/:id/:token', upload_1.default.none(), auth_controller_1.AuthController.resetPassword);
