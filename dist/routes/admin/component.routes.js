...
Router.put("/update-component/:type/:scenario_id", authentification_1.authentification, (0, authorization_1.authorization)(["admin"]), component_controller_1.ComponentController.update);
Router.delete("/delete-component/:type/:simulation_id", authentification_1.authentification, (0, authorization_1.authorization)(["admin"]), component_controller_1.ComponentController.delete);
